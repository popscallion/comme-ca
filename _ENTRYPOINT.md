...
- `README.md`: Workflows (Spec, Inbox, Roles).
- `requirements.md`: PRD and Directory Structure.
- `AGENTS.md`: Agent Orchestration Rules.
- `scaffolds/`: Distributed templates.

## 4. Quick Links

- **Active Specs:** `specs/active/` (Transitional)
- **Problem specs:** `specs/headless-claude/`
- **Scaffolds:** `scaffolds/high-low/`
