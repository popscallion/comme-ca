...
## Summary
Add portable QA guardrails to the comme-ca scaffolding system via `pre-commit`, using an adversarial AI sentinel that evaluates staged diffs against `docs/TESTING-GUARDRAILS.md` and supplemental patterns.
...
- Provide an AI QA sentinel hook driven by `docs/TESTING-GUARDRAILS.md`.
